...
public final class StdRandomTester {
    ...
    /**
     * The main method takes in a 4 command line arguments. The first the amount of Array(Lists) to be created,
     * the second is holding the size of 1,000 for a set of Array(Lists), the third is holding the size of
     * 10,000 for a set of Array(Lists), and the fourth is a new seed. Two ArrayLists are initialize, one for
     * Integers and the other for Doubles. A loop is then done with a switch statement that performs 4 different
     * distributions and creates two Array(Lists). One being a quantity 1,000 and the other 10,000. They are
     * then iterated through with a for-each loop and printed.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        //Commandline argument variable for the amount of Arrays to be made
        int times = Integer.parseInt(args[0]);
        //Commandline argument variable for size 1,000
        int quantityThousand = Integer.parseInt(args[1]);
        //Commandline argument variable for size 10,000
        int quantityTenThousand = Integer.parseInt(args[2]);
        //Commandline argument variable for the new seed
        int randNum = Integer.parseInt(args[3]);
        setSeed(randNum);
        ArrayList<Double> distDoubles = new ArrayList<>();
        ArrayList<Integer> distIntegers = new ArrayList<>();
        //For loop for the amount of Arrays to be made and printed
        for (int i = 0; i < times; i++) {
                //Start of switch statement
                switch (i) {
                    //Case 0 is for the pareto distribution
                    case 0:
                        System.out.println("Pareto Distribution (1,000 Results)");
                        System.out.println("----------------------");
                        //Loops 1,000 times and adds a number from the distribution into the ArrayList
                        for (int j = 0; j < quantityThousand; j++) {
                            double answer = pareto(randNum);
                            distDoubles.add(answer);
                        }
                        //Iterates and print contents
                        for (Double distDouble : distDoubles) {
                            System.out.printf("'%1.5f' ", distDouble);
                        }

                        System.out.println();
                        //Contents are cleared to make room for a different size or different distribution
                        distDoubles.clear();

                        System.out.println("Pareto Distribution (10,000 Results)");
                        System.out.println("----------------------");
                        //Loops 10,000 times and adds a number from the distribution into the ArrayList
                        for (int j = 0; j < quantityTenThousand; j++) {
                            double answer = pareto(randNum);
                            distDoubles.add(answer);
                        }
                        //Iterates and prints contents
                        for (Double distDouble : distDoubles) {
                            System.out.printf("'%1.5f' ", distDouble);
                        }
                        //Contents are cleared to make room for a different size or different distribution
                    ...
                    case 1:
                        //Case 1 uses the Uniform Distribution with Integers
                        System.out.println("Uniform Distribution with Integer (1,000 Results)");
                        System.out.println("----------------------");
                        //Loop for 1,000 and add to the Integer ArrayList
                        for (int j = 0; j < quantityThousand; j++) {
                            int answer = uniformInt(randNum);
                            distIntegers.add(answer);
                        }
                        //Iterate with for-each and print
                        for(Integer distInteger: distIntegers){
                            System.out.print(distInteger + " ");
                        }
                        ...
                        System.out.println("Uniform Distribution with Integer (10,000 Results)");
                        System.out.println("----------------------");
                        //Loop for 10,000 and add to the Integer ArrayList
                        for (int j = 0; j < quantityTenThousand; j++) {
                            int answer = uniformInt(randNum);
                            distIntegers.add(answer);
                        }
                        ...
                        break;
                    case 2:
                        //Case 2 uses a Uniform Distribution with Doubles
                        System.out.println("Uniform Distribution with Double (1,000 Results)");
                        System.out.println("----------------------");
                        //Loop for 1,000 and add to the Double ArrayList
                        for (int j = 0; j < quantityThousand; j++) {
                            double answer = uniformDouble(1.0,seed);
                            distDoubles.add(answer);
                        }
                        //Iterate with for-each and print
                        for (Double distDouble : distDoubles) {
                            System.out.printf("'%2.2f' ", distDouble);
                        }
                        System.out.println();
                        //Contents are cleared to make room for a different size or different distribution
                        distDoubles.clear();

                        System.out.println("Uniform Distribution with Double (10,000 Results)");
                        System.out.println("----------------------");
                        //Loop for 10,000 and add to the Double ArrayList
                        for (int j = 0; j < quantityTenThousand; j++) {
                            double answer = uniformDouble(1.0,seed);
                            distDoubles.add(answer);
                        }
                        ...
                        break;
                    case 3:
                        //Case 3 uses a Gaussian Distribution
                        System.out.println("Gaussian Distribution (1,000 Results)");
                        System.out.println("----------------------");
                        //Loop for 1,000 and add to the Double ArrayList
                        for (int j = 0; j < quantityThousand; j++) {
                            double answer = gaussian(1.0,seed);
                            distDoubles.add(answer);
                        }
                        //Iterate with for-each and print
                        for (Double distDouble : distDoubles) {
                        ...
                        System.out.println("Gaussian Distribution (10,000 Results)");
                        System.out.println("----------------------");
                        //Loop for 10,000 and add to the Double ArrayList
                        for (int j = 0; j < quantityTenThousand; j++) {
                            double answer = uniformDouble(1.0,seed);
                    ...
                    default:
                        ...
                        System.out.println("Default prints a result from the bernoulli distribution");
                        System.out.println("Program only uses the printed distributions");
                }
            }
        }
    }
